                    ...
                    <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                        ...
                        <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                            <div class="u-info me-2">
                                <p class="mb-0 text-end line-height-sm "><span class="font-weight-bold">{{session()->get('admin')->name}}</span></p>
                            ...
                            <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                <div class="card border-0 w280">
                                    <div class="card-body pb-0">
                                        <div class="d-flex py-1">
                                            ...
                                            <div class="flex-fill ms-3">
                                                <p class="mb-0"><span class="font-weight-bold">{{session()->get('admin')->name}}</span></p>
                                                <small class="">{{session()->get('admin')->email}}</small>
                                            </div>
                                        </div>
                                    ...
                                    <div class="list-group m-2 ">
                                        ...
                                        <a href="{{URL('admin')}}" class="list-group-item list-group-item-action border-0 "><i class="icofont-ui-user-group fs-6 me-3"></i>Users</a>
                                        <a href="{{URL('admin/logout')}}" class="list-group-item list-group-item-action border-0 "><i class="icofont-logout fs-6 me-3"></i>Signout</a>
                                        <!-- <div><hr class="dropdown-divider border-dark"></div> -->
