                            ...
                            <div class="card-body card-body-height py-4">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <h6 class="mb-0 fw-bold mb-3">Feedback Chat</h6>
                                            @php 
                                            ...
                                            <li class="card mb-2">
                                                <div class="card-body">
                                                    <div class="timeline-item-post">
                                                        ...
                                                        <div class="mb-2 mt-4">
                                                            <a class="me-lg-4 me-2 text-primary" href="#"><i class="icofont-speech-comments"></i> Comments</a>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <div class="d-flex mt-3 pt-3 border-top">
                                                                ...
                                                                <div class="flex-fill ms-3 text-truncate">
                                                                    <p class="mb-0"><span>{{ $comment->user->name }}</span> <small class="msg-time">Created on {{ date('jS M Y', strtotime($post->updated_at)) }}</small></p>
                                                                    <span class="text-muted">{{ $comment->body }}</span>
                                                                    <!-- <button type="button" class="btn btn-primary" data-bs-toggle="button" autocomplete="off">Enable </button> -->
                                                                </div>
                                                            </div>
                                                            @endforeach
                                                            <!-- <div class="d-flex mt-3 pt-3 border-top">
